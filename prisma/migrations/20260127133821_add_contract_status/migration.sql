...
INSERT INTO "new_Client" ("accountantId", "billingContactId", "chatworkGroup", "code", "contactPerson", "createdAt", "description", "email", "id", "isArchived", "lastContactDate", "name", "operationsLeadId", "sns1", "sns2", "sns3", "updatedAt", "website") SELECT "accountantId", "billingContactId", "chatworkGroup", "code", "contactPerson", "createdAt", "description", "email", "id", "isArchived", "lastContactDate", "name", "operationsLeadId", "sns1", "sns2", "sns3", "updatedAt", "website" FROM "Client";
DROP TABLE "Client";
